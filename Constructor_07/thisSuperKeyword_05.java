...
class Student1{
    ...
    public Student1(){ // 2) control comes here first then goes to this("Rohit",19)
       ...
       // super(); // Calling parent class constructor
        ...
        this("Rohit", 19); //[2] // 3) now control goes to Parameterized Constructor with two parameters because this() contains two parameters
    ...
    public Student1(String name){ // 9) control comes here from main method and values are initialized here name="Rahul"
        ...
        this(); //[1] // from here control goes to zero parameter constructor
        this.name = name;
        age = 19;
